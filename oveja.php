...
$patient_status = $_POST['Estado_fisiologico'];
$patient_zoo = $_POST['zootecnico'];
$patient_production = $_POST['produccion'];
$patient_fc = $_POST['FC'];
$patient_fr = $_POST['FR'];
...
Peso: '.$patient_weight.' 
Sexo: '.$patient_gender.' 
Etapa fisiológica: '.patient_status.'
Fin zootécnico: '.$patient_zoo.'
Sistema de producción: '.$patient_production.'
Frecuencia cardiaca: '. $patient_fc .' lpm
Frecuencia respiratoria: '. $patient_fr .' rpm
Temperatura: '. $patient_temp .' °C
Coloración de mucosas: '.$patient_mucose.'
Linfonodos: '.$patient_node.'
